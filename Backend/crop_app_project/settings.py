"""
Django settings for DS2_SOA project.
...
SECRET_KEY = "django-insecure-*9yuhv(v-0tsk((bd#pbp=xr!#)f&w^yoy*!lp0$28hg*4$p6j"
...
#I WONT USE IT BECAUSE I WILL USE DJANGO FOR BAC AND FRONTEND!!!
